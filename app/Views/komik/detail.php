        ...
        <div class="col">
            ...
            <div class="card mb-3" style="max-width: 540px;">
                <div class="row g-0">
                    ...
                    <!-- <img src="/img/pertama.jpeg" alt="" width="100" height="100" class="pull-right"> -->
                            ...
                            <a href="/komik/pdf/<?= $komik['slug']; ?>" class="btn btn-success">Formulir</a>
                            ...
                            <br><br>
                            <a href="/komik"> Kembali ke data pemain</a>
                        </div>
                    </div>
                </div>
            </div>
